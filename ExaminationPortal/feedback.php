...
<div class="col-lg-6">
<span class="logo">EP(Examination Portal)</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-6 panel" style="background-image:url(image/bg4.jpg); min-height:420px;">
...
<div class="col-md-10">
<a href="mailto:princecbi2020@gmail.com" style="color:red">princecbi2020@gmail.com</a><br /><br />
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="row">
    <div class="col-md-4">
     <img src="image\Anjali.jpg" width=100 height=100 alt="Anjali Kumari" class="img-rounded">
     </div>
     <div class="col-md-5">
    <a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Instagram">Anjali Kumari</a>
